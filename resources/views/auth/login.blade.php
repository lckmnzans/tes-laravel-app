...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased">
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            <div class="absolute inset-0">
                <img src="{{asset('style/assets/images/auth/bg-gradient.png')}}" alt="image" class="h-full w-full object-cover">
            </div>
            ...
            <div class="relative flex min-h-screen items-center justify-center bg-[url(../images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
                <img src="{{asset('style/assets/images/auth/coming-soon-object1.png')}}" alt="image" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2">
                <img src="{{asset('style/assets/images/auth/coming-soon-object2.png')}}" alt="image" class="absolute left-24 top-0 h-40 md:left-[30%]">
                <img src="{{asset('style/assets/images/auth/coming-soon-object3.png')}}" alt="image" class="absolute right-0 top-0 h-[300px]">
                <img src="{{asset('style/assets/images/auth/polygon-object.svg')}}" alt="image" class="absolute bottom-0 end-[28%]">
                ...
                <div class="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]">
                    ...
                    <!-- Reduced top spacing for the form -->
                    <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[650px] py-10">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="space-y-5 dark:text-white">
                                ...
                                <div>
                                    <label class="flex items-center cursor-pointer">
                                        <input id="remember_me" type="checkbox" name="remember" class="form-checkbox bg-white dark:bg-black">
                                        <span class="text-white-dark ml-2">Remember Me</span>
                                    </label>
                                </div>

                                <!-- Submit Button -->
                                <button type="submit" class="btn btn-gradient w-full mt-6 border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">Sign In</button>
                            </form>

                            <!-- Forgot Password 
                            @if (Route::has('password.request'))
                                <div class="text-center mt-4">
                                    <a href="{{ route('password.request') }}" class="text-sm text-primary underline">Forgot your password?</a>
                                </div>
                            @endif-->
                        </div>
                    </div>
    ...
    <!-- Scripts -->
    <script src="{{ asset('style/assets/js/alpine.min.js') }}"></script>
